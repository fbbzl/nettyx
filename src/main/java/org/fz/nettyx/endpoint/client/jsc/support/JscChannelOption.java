...
import org.fz.nettyx.endpoint.client.jsc.support.JscChannelConfig.DataBits;
...
public final class JscChannelOption<T> extends ChannelOption<T> {
    ...
    public static final ChannelOption<DataBits>  DATA_BITS    = valueOf(JscChannelOption.class, "DATA_BITS");
