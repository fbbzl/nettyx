...
public class Prop {
    ...
    public static class PropType {
        ...
        public boolean isNumber() {
            return NumberConverter.convertible(getValue());
        }

        public boolean isString() {
            return CharSequenceUtil.startWithIgnoreCase(getValue(), "string");
        }

        public boolean isEnum() {
            return CharSequenceUtil.startWithIgnoreCase(getValue(), "enum");
        }

        public boolean isSwitch() {
            return CharSequenceUtil.startWithIgnoreCase(getValue(), "switch");
        }

        public boolean isArray() {
            return ARRAY_PATTERN.matcher(getValue()).matches();
        }
