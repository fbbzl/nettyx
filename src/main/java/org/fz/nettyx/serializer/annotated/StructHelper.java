...
import static org.fz.nettyx.serializer.annotated.AnnotatedStructContext.*;
import static org.fz.nettyx.serializer.annotated.generator.StructAccessorFactory.get;
...
public class StructHelper {
    ...
    public static <S> S newStruct(Type structType)
    {
        try
        {
            AnnotatedStructContext.StructDefinition definition = getStructDefinition(structType);
