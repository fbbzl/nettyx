...
public interface StructFieldHandler<A extends Annotation> {
    ...
    default <B extends Basic<?>> B readBasic(
            Class<?> basicType,
            ByteBuf  byteBuf)
    {
    ...
    default <T> void writeStructArray(
            T[]     structArray,
            Type    elementType,
            int     length,
            ByteBuf writing)
