...
public final class StructSerializer implements Serializer {
    ...
    {
        StructDefinition structDef = findStructDefinition(root);
    ...
    StructDefinition findStructDefinition(Type type)
    {
       return Objects.requireNonNull(getStructDefinition(type), () -> "can not find struct definition by: [" + type + "]");
    }
