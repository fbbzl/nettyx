...
import org.fz.nettyx.coveragebasic.TooLessConstructorBasic;
...
public class BasicTest {
    ...
    @Test
    public void reflectForSizeHandlesSuccessfulAndExceptionalConstructors() {
        assertEquals(4, Basic.reflectForSize(cint.class));
        assertThrows(SerializeException.class,
                     () -> Basic.reflectForSize(org.fz.nettyx.coveragebasic.MissingConstructorBasic.class));
        assertThrows(TooLessBytesException.class,
                     () -> Basic.reflectForSize(TooLessConstructorBasic.class));
        assertThrows(SerializeException.class,
                     () -> Basic.reflectForSize(UnexpectedIndexBasic.class));
    }
