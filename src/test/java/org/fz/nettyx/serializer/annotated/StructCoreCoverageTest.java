...
import org.fz.nettyx.serializer.annotated.AnnotatedStructContext.StructDefinition;
import org.fz.nettyx.serializer.annotated.AnnotatedStructContext.StructDefinition.StructField;
import org.fz.nettyx.serializer.annotated.annotation.Ignore;
...
import static org.fz.nettyx.serializer.annotated.StructFieldHandler.DEFAULT_STRUCT_FIELD_HANDLER;
import static org.fz.nettyx.serializer.annotated.AnnotatedStructContext.getStructDefinition;
...
public class StructCoreCoverageTest {
    ...
    public static void scanModels() {
        new AnnotatedStructContext("org.fz.nettyx.beanmodel.support",
    ...
    public void helperCoversLookupConstructionFieldAndArraySemantics() throws Exception {
        ...
        BiFunction<ByteBuf, ByteOrder, ?> original = AnnotatedStructContext.BASIC_CONSTRUCTOR_CACHE.get(cint.class);
        try {
            AnnotatedStructContext.BASIC_CONSTRUCTOR_CACHE.put(cint.class,
            ...
            AnnotatedStructContext.BASIC_CONSTRUCTOR_CACHE.put(cint.class, original);
        }
    }
    ...
    public void handlerAnnotationResolutionIgnoresUnrelatedInterfacesAndSupportsInheritance() {
        assertEquals(TestHandlerAnnotation.class, AnnotatedStructContext.getTargetAnnotationType(MultiInterfaceHandler.class));
        assertEquals(TestHandlerAnnotation.class, AnnotatedStructContext.getTargetAnnotationType(InheritedHandler.class));
        assertNull(AnnotatedStructContext.getTargetAnnotationType(GenericHandler.class));
        assertNull(AnnotatedStructContext.getTargetAnnotationType(StructFieldHandler.class));
    }

    @Test
    public void contextValidationCoversInvalidStructAndBasicDefinitions() {
        new AnnotatedStructContext("java.lang");
        assertTrue(AnnotatedStructContext.isScannableClass(AccessorBean.class));
        assertFalse(AnnotatedStructContext.isScannableClass(String.class));
        assertFalse(AnnotatedStructContext.isScannableClass(Integer.class));
        assertFalse(AnnotatedStructContext.isScannableClass(StructFieldHandler.class));
        assertFalse(AnnotatedStructContext.isScannableClass(AbstractCoverageStruct.class));
        assertFalse(AnnotatedStructContext.isScannableClass(null));
    ...
    private static class ExposedContext extends AnnotatedStructContext {
        ExposedContext() {
