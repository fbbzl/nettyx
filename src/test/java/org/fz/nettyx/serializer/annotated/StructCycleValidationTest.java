...
public class StructCycleValidationTest {
    ...
    public void acceptsReferenceToStructWithoutDefinition() {
        ...
        assertNotNull(AnnotatedStructContext.getStructDefinition(CycleStructs.MissingDefinitionRoot.class));
        assertNull(AnnotatedStructContext.getStructDefinition(CycleStructs.MissingDefinitionLeaf.class));
    }
    ...
    public void rejectsToArrayOnNonArrayFieldBeforeCycleAnalysis() {
        ...
        assertNull(AnnotatedStructContext.getStructDefinition(CycleStructs.NonArrayAnnotation.class));
    }
    ...
    public void acceptsAcyclicStructGraph() {
        ...
        assertNotNull(AnnotatedStructContext.getStructDefinition(CycleStructs.AcyclicRoot.class));
    }
    ...
    private static void assertCycle(String expectedPath, Class<?>... types) {
        ...
        for (Class<?> type : types) assertNull(AnnotatedStructContext.getStructDefinition(type));
    }
