...
public class NettyxEscape {
    ...
    private static final InternalLogger log = InternalLoggerFactory.getInstance(NettyxEscape.class);
    ...
    public static void main(String[] args) {
        ...
        log.info("Nettyx " + stopWatch.prettyPrint(TimeUnit.MILLISECONDS));
    }
